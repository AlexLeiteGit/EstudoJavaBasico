...
public class PassArray {
	...
	public static void main(String[] args) {
		...
		System.out.printf("Effects of passing reference to entire array:" + "%nThe values of the original array are:%n");
		...
		modifyArray(array);
		System.out.printf("%n%nThe values os the modified array are:%n");
